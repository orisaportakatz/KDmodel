function RHS = diffusionEquation_oscBC_param19_mixed(t, S, BCtype, Lx, Ly, Lz, X_eval, Y_eval, Z_eval, X_cell, Y_cell, Z_cell, SForcing, T_atm)
...
Fz_diffusion(2:end-1,:,:) = kappaz * diff(S,1,1)./(diff(Z_eval,1,1));
