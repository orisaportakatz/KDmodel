function RHS = diffusionEquation_oscBC_param19_mixed_northHighDiff_restoring(t, S, BCtype, Lx, Ly, Lz, y_eval, X_eval, Y_eval, Z_eval, X_cell, Y_cell, Z_cell, S_atm, T_atm, northLat_ind)
...
% Regular diffusion in bulk, high diffusion in north:
% create diffusion vector with low diffusion in south and high diffusion in
% the north:
northLat = (53-65)/(10-65);
kappaz_vec = kappaz + 1/2*(1+(tanh(20*((1-y_eval)-1+northLat))))*(kappaz_enh - kappaz);
kappaz_matrix = repmat(kappaz_vec,29,1,65);
